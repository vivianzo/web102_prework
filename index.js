...
const descriptionText = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently ${unfundedCount} games remain unfunded. We need your help to fund these amazing games!` 
